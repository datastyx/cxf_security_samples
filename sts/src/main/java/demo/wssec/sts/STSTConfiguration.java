...
public class STSTConfiguration {
    ...
    String serverAddress = "https://localhost:"+port+"/SecurityTokenService/UT";
    ...
    String wsdlPath = "wsdl/ws-trust-1.4-service.wsdl";
...
String serviceKeystorePropertyfile = "serviceKeystore.properties";
    ...
    JettyHTTPServerEngineFactory jettyHTTPServerEngineFactory() throws IOException, GeneralSecurityException {
        ...
        jettyHTTPServerEngineFactory.setBus(cxf);
    ...
    public TokenIssueOperation utIssueDelegate() {
        ...
        tokenIssueOperation.setDelegationHandlers( Arrays.asList(new SAMLDelegationHandler())); //delegation support handler
        tokenIssueOperation.setTokenValidators(Arrays.asList(new SAMLTokenValidator())); // delegated SAML token validator
    ...
    public Endpoint endpoint() throws Exception {
        EndpointImpl endpoint = new EndpointImpl(cxf, utSTSProviderBean());
        ...
        // propertyMap.put("ws-security.enable.streaming", true);   // activate XML Stax streaming
