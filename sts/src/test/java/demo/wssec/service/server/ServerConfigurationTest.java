package demo.wssec.service.server;
...
public class ServerConfigurationTest {
    ...
    String wsdlPath = "src/test/resources/hello_world.wsdl";

    // String serverAddress = "https://localhost:9001/SoapContext/SoapPort";
    public final static int PORT = 49001;

    String serviceKeystorePropertyfile = "src/test/resources/server/serviceKeystore.properties";
