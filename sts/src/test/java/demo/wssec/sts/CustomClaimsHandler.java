...
import demo.wssec.sts.CustomClaimParser.CustomRequestClaim;
        ...
        if (claims != null && !claims.isEmpty()) {
            ...
            for (Claim requestClaim : claims) {
                ...
                if (ClaimTypes.FIRSTNAME.toString().equals(requestClaim.getClaimType())) {
                    ...
                    if(parameters.getPrincipal().getName().equalsIgnoreCase("alice")){
                        claim.addValue("alice@datastyx.com");
                    } else{
                        claim.addValue("bob@datastyx.com");
                    }
                    ...
                    if(parameters.getPrincipal().getName().equalsIgnoreCase("alice")){
                        ...
                        claim.addValue("5678 2nd Street");
                    }
                    ...
                    XSInteger attributeValue =
                        ...
                        if(parameters.getPrincipal().getName().equalsIgnoreCase("alice")){
                            ...
                            attributeValue.setValue(987654321);
                        }
